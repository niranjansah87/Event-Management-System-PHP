...
#viewer_modal .modal-dialog {
  ...
  body, footer {
    background-image: url('assets\img\Plan.jpeg');
      background-repeat: no-repeat;
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="admin\signup.php?page=home">Signup</a></li>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - <?php echo $_SESSION['system']['name'] ?> | <a class="text-success" href="https://niranjansah.com.np/" target="_blank">NIRANJAN</a></div></div>
        </footer>
